...
namespace PIDController
{
    ...
    public class PIDController
    {
        ...
        [HideInInspector] public float valueLast;
        [HideInInspector] public float errorLast;
        [HideInInspector] public float integrationStored;
        [HideInInspector] public float velocity;  //only used for the info display
        [HideInInspector] public bool derivativeInitialized;

        public PIDController(float proportionalGain = 1, float integralGain = 1, float derivativeGain = 1, float integralSaturation = 1)
        {
